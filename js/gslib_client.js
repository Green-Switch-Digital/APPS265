/*
-------GreenSwitch Framework for rapid development----
Author : Green Switch Labs
Developer : Wongani Kaluwa
Contacts : 0882931367
--------------------------
Dont forget to like our facebook page for updates
http://facebook.com/greenswitch
------------------------------++++++++----
Also try our green switch server api for javascript sql direct alterations. Run queries directly with javascript. Bringing serverside language to javascript.
1: GreenSwitch Server
2: GreenSwitch Java API
3: GreenSwitch Apple
--------------------------
-----------
To use this, place it in the header of your webpages.
*/

var GSVersion="v.1.2.0";
var GSState="running";
